...
{
    public class MockMerchandiseRepository : IMerchandiseRepository
    {
        ...
        public IEnumerable<Merchandise> Merchandises
        {
            get
            {
                return new List<Merchandise>
                {
                    new Merchandise {
                        Name = "Beer",
                        Value = 7, ShortDescription = "The most widely consumed alcohol",
                    ...
                    new Merchandise {
                        Name = "Rum & Coke",
                        Value = 12, ShortDescription = "Cocktail made of cola, lime and rum.",
                    ...
                    new Merchandise {
                        Name = "Tequila ",
                        Value = 12, ShortDescription = "Beverage made from the blue agave plant.",
        ...
        public IEnumerable<Merchandise> PreferredMerchandises { get; }
        public Merchandise GetMerchandiseById(int drinkId)
        {
